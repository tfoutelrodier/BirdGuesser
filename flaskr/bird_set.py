...
# from db import get_db, records2list_of_dict
...
#####
# Old code used at the begining when trying to use a database to store bird data
# Discarded as use a csv in first intention now 
# left as comment in case can be used as a base if improving from csv to sqlite or other database in the future
#####
